...
import type { TransactionsSelectFieldProps } from "@/modules/transactions/types/transactions.types";
import { Label } from "@/shared/components/shadcn/ui/label";
import { Box } from "@/shared/components/ui/box";
import { Stack } from "@/shared/components/ui/stack";

export function TransactionsSelectField({
  id,
  label,
  value,
  options,
