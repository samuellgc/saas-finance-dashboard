import type { TransactionFormSelectFieldProps } from "@/modules/transactions/types/transactions.types";
...
export function TransactionFormSelectField({
  id,
  label,
  value,
  options,
  ...
  disabled = false,
  onChange,
}: TransactionFormSelectFieldProps) {
  return (
    <Stack gap="2">
